...
clear ; close all; 
%clf; shg;
list = dir('D:\First semester\data mining\Datasets\Incomplete+Datasets\4-gauss\');

%% =========== Step 0: Loading and Visualizing Image Randomly =============
d = xlsread('D:\First semester\data mining\Self-Organizing-Map-master\Self-Organizing-Map-master\Blend1.xlsx');
%load Aggregation.txt;
train_data = d(1:size(d,1)/2,:);
y = d (:, end);
